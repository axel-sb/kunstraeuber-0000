// webdesign.tutsplus.com/create-an-html5-canvas-tile-swapping-puzzle--active-10747t#page-body

function initializePuzzleGame(imgUrl, onGameOver) {
    ...
    // A copy of the complete original image for reference
    ...
    function shufflePuzzle() {
        // let refImg = document.querySelector('#refImg').classList.add('refImg')
    ...
    function gameOver() {
        ...
        // Create explosions at intervals - REMOVE INTERVAL
        onGameOver() // start confetti explosion
    ...
    function updateDifficulty(e) {
        ...
        puzzleWidth = pieceWidth * difficulty
        puzzleHeight = pieceHeight * difficulty
        resetPuzzle() // Call resetPuzzle instead of gameOver
    }
    document.querySelector('#difficulty').oninput = updateDifficulty

    function resetPuzzle() { // New resetPuzzle function
        onImage() // Re-initialize puzzle without game over
    }
