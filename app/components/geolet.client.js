...
;(function () {
	...
	var _merge = function (object1, object2) {
		...
		for (Object.key in object2)
			if ({}.hasOwnProperty.call(object2, Object.key)) {
				if (
					typeof object2[Object.key] == 'object' &&
					object2[Object.key] !== null &&
					Object.getPrototypeOf(object2[Object.key]) ==
						Object.getPrototypeOf({})
				) {
					//Plain object: merge the next level
					object1[Object.key] = _merge(object1[Object.key], object2[Object.key])
				} else {
					//Anything else (including typed objects): just assign it
					object1[Object.key] = object2[Object.key]
				}
			}
