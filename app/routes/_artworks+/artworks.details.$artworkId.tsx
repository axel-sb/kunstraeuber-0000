...
export default function ArtworkDetails() {
	...
	return (
		<>
			<div className="details-container grid-rows-[minmax(min-content, 1fr)] grid w-screen grid-cols-[30%_70%] items-center justify-around justify-items-center 2xl:ml-[10%]">
				<div className="first-half-wrapper justify-end-end col-span-full row-[1_/_2] max-h-[calc(100dvh)] max-w-[calc(100%-2rem)] flex-wrap items-center self-start pb-12 2xl:col-[1_/_2] 2xl:row-span-full 2xl:ml-auto 2xl:mr-2 2xl:max-w-[45%] 2xl:justify-end">
					...
					<img
						...
						className="rounded-md 2xl:mt-12 2xl:rounded-lg"
					/>
				</div>
				...
				<div
					className="halftone-wrapper col-span-full row-[1_/_2] hidden max-h-[calc(100dvh)] max-w-[calc(100%-2rem)] flex-wrap items-center self-start pb-12 2xl:col-[1_/_2] 2xl:row-span-full 2xl:ml-auto 2xl:mr-2 2xl:max-w-[843px] 2xl:justify-end"
					style={
						{
